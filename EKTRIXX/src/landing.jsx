...
function BrandSynthesizer({ onShop }) {
  const cells = [
    { id: "perf",    cat: "01 / Performance", name: "Move",    count: "06 STYLES", cls: "synth__cell--lg", img: "assets/hero-orange-tee.png" },
    ...
    { id: "tees",    cat: "04 / Heavy Tees",     name: "Layer", count: "11 STYLES", cls: "synth__cell--sm", img: "assets/product-soul07-white.png" },
    { id: "acc",     cat: "05 / Hardware",       name: "Equip", count: "04 STYLES", cls: "synth__cell--sm", img: null, ph: "ACCESSORIES · HARDWARE" },
  ];
  return (
